...
public enum SpecialModels
{
    ...
    TAXI_BODY("taxi_body"),
    POLICIAL_BODY("policial_body"),
    PEUGEOT_BODY("peugeot_body"),
    BICI_BODY("bici_body"),
    BICI_HANDLE_BAR("bici_handle_bar"),
    BICI_BODY_2("bici_body_2"),
    BICI_HANDLE_BAR_2("bici_handle_bar_2"),
    ...
    SMART_CAR_BODY_2("smart_car_body_2"),
    DEPORTIVE_BODY("temporaly_body"),
    DEPORTIVE_BODY_2("temporaly_body_2"),
    DEPORTIVE_BODY_3("temporaly_body_3"),
    ...
    SPORTS_PLANE_BODY_2("sports_plane_body_2"),
    SPORTS_PLANE_TALL_2("sports_plane_tall_2"),
    BUS_BODY("bus_body"),
    BUS_BODY_2("bus_body_2"),
    BUS_BODY_3("bus_body_3"),
    GOLF_CART_BODY("golf_cart_body"),
    OFF_ROADER_BODY("off_roader_body"),
    TRACTOR_BODY("tractor_body"),
    TRAILER_BODY("trailer_body"),
    TRAILER_BIG_BODY("trailer_big_body"),
    LIMUSINA_BODY("limusina_body"),
    RENAULT_BODY("renault_body"),
