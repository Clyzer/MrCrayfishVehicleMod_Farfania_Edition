...
import com.mrcrayfish.vehicle.entity.vehicle.DeportiveEntity;
 ...
 * Author: MrCrayfish
 */
public class DeportiveRenderer extends AbstractLandVehicleRenderer<DeportiveEntity>
{
    public DeportiveRenderer(VehicleProperties defaultProperties)
    {
        super(defaultProperties);
    }

    @Override
    public void render(@Nullable DeportiveEntity vehicle, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, float partialTicks, int light)
    {
        this.renderDamagedPart(vehicle, SpecialModels.DEPORTIVE_BODY.getModel(), matrixStack, renderTypeBuffer, light);
    ...
    @Override
    public void applyPlayerModel(DeportiveEntity entity, PlayerEntity player, PlayerModel model, float partialTicks)
    {
