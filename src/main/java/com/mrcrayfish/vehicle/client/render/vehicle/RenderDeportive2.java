...
import com.mrcrayfish.vehicle.entity.vehicle.EntityDeportive2;
 ...
 * Author: MrCrayfish
 */
public class RenderDeportive2 extends AbstractRenderVehicle<EntityDeportive2>
{
    @Override
    public void render(EntityDeportive2 entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.DEPORTIVE_BODY_2.getModel());

        //Render the handles bars
        GlStateManager.pushMatrix();
        {
            GlStateManager.translate(0.25, 0.2, 0.5);
    ...
    @Override
    public void applyPlayerModel(EntityDeportive2 entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
