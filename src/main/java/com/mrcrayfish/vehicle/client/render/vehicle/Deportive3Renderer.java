...
import com.mrcrayfish.vehicle.entity.vehicle.Deportive3Entity;
 ...
 * Author: MrCrayfish
 */
public class Deportive3Renderer extends AbstractLandVehicleRenderer<Deportive3Entity>
{
    public Deportive3Renderer(VehicleProperties defaultProperties)
    {
        super(defaultProperties);
    }

    @Override
    public void render(@Nullable Deportive3Entity vehicle, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, float partialTicks, int light)
    {
        this.renderDamagedPart(vehicle, SpecialModels.DEPORTIVE_3_BODY.getModel(), matrixStack, renderTypeBuffer, light);
    ...
    @Override
    public void applyPlayerModel(Deportive3Entity entity, PlayerEntity player, PlayerModel model, float partialTicks)
    {
    ...
    public EntityRayTracer.IRayTraceTransforms getRayTraceTransforms()
    {
        ...
        {
            EntityRayTracer.createTransformListForPart(SpecialModels.DEPORTIVE_3_BODY, parts, transforms);
            ...
            EntityRayTracer.createFuelPartTransforms(ModEntities.DEPORTIVE_3.get(), SpecialModels.FUEL_DOOR_CLOSED, parts, transforms);
        };
    }
}
