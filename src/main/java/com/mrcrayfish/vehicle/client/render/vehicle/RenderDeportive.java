...
import com.mrcrayfish.vehicle.entity.vehicle.EntityDeportive;
 ...
 * Author: MrCrayfish
 */
public class RenderDeportive extends AbstractRenderVehicle<EntityDeportive>
{
    @Override
    public void render(EntityDeportive entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.DEPORTIVE_BODY.getModel());
    ...
    @Override
    public void applyPlayerModel(EntityDeportive entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
