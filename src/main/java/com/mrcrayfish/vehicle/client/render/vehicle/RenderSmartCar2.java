...
import com.mrcrayfish.vehicle.entity.vehicle.EntitySmartCar2;
 ...
 * Author: MrCrayfish
 */
public class RenderSmartCar2 extends AbstractRenderVehicle<EntitySmartCar2>
{
    @Override
    public void render(EntitySmartCar2 entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.SMART_CAR_BODY_2.getModel());

        //Render the handles bars
        GlStateManager.pushMatrix();
        {
            GlStateManager.translate(0, 0.2, 0.6);
    ...
    @Override
    public void applyPlayerModel(EntitySmartCar2 entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
