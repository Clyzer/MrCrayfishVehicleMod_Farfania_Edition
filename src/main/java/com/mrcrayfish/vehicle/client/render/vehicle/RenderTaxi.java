...
import com.mrcrayfish.vehicle.entity.vehicle.EntityTaxi;
 ...
 * Author: MrCrayfish
 */
public class RenderTaxi extends AbstractRenderVehicle<EntityTaxi>
{
    @Override
    public void render(EntityTaxi entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.TAXI_BODY.getModel());
    ...
    @Override
    public void applyPlayerModel(EntityTaxi entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
