...
import com.mrcrayfish.vehicle.entity.vehicle.EntityPeugeot;
 ...
 * Author: MrCrayfish
 */
public class RenderPeugeot extends AbstractRenderVehicle<EntityPeugeot>
{
    @Override
    public void render(EntityPeugeot entity, float partialTicks)
    {
        GlStateManager.pushMatrix();
        {
        	...
        	this.renderDamagedPart(entity, SpecialModels.PEUGEOT_BODY.getModel());
        }
    ...
    @Override
    public void applyPlayerModel(EntityPeugeot entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
