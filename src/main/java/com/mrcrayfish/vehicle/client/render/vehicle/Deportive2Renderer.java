...
import com.mrcrayfish.vehicle.entity.vehicle.Deportive2Entity;
 ...
 * Author: MrCrayfish
 */
public class Deportive2Renderer extends AbstractLandVehicleRenderer<Deportive2Entity>
{
    public Deportive2Renderer(VehicleProperties defaultProperties)
    {
        super(defaultProperties);
    }

    @Override
    public void render(@Nullable Deportive2Entity vehicle, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, float partialTicks, int light)
    {
        this.renderDamagedPart(vehicle, SpecialModels.DEPORTIVE_2_BODY.getModel(), matrixStack, renderTypeBuffer, light);
    ...
    @Override
    public void applyPlayerModel(Deportive2Entity entity, PlayerEntity player, PlayerModel model, float partialTicks)
    {
    ...
    public EntityRayTracer.IRayTraceTransforms getRayTraceTransforms()
    {
        ...
        {
            EntityRayTracer.createTransformListForPart(SpecialModels.DEPORTIVE_2_BODY, parts, transforms);
            ...
            EntityRayTracer.createFuelPartTransforms(ModEntities.DEPORTIVE_2.get(), SpecialModels.FUEL_DOOR_CLOSED, parts, transforms);
        };
    }
}
