...
import com.mrcrayfish.vehicle.entity.vehicle.EntityBici;
 ...
 * Author: MrCrayfish
 */
public class RenderBici extends AbstractRenderVehicle<EntityBici>
{
    @Override
    public void render(EntityBici entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.BICI_BODY.getModel());
        ...
        GlStateManager.pushMatrix();
        {
            ...
            this.renderDamagedPart(entity, SpecialModels.BICI_HANDLE_BAR.getModel());
    ...
    @Override
    public void applyPlayerModel(EntityBici entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
        float wheelAngle = entity.prevRenderWheelAngle + (entity.renderWheelAngle - entity.prevRenderWheelAngle) * partialTicks;
        float wheelAngleNormal = wheelAngle / 45F;
    ...
    @Override
    public void applyPlayerRender(EntityBici entity, EntityPlayer player, float partialTicks)
    {
