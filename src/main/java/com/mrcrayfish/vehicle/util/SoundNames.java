...
public class SoundNames
{
    ...
    public static final String HORN_BICI_MONO = PREFIX + "horn_bici_mono";
    public static final String HORN_BICI_STEREO = PREFIX + "horn_bici_stereo";
    ...
    public static final String BICI_ENGINE_MONO = PREFIX + "bici_engine_mono";
    public static final String BICI_ENGINE_STEREO = PREFIX + "bici_engine_stereo";
    ...
    public static final String VEHICLE_CRASH = PREFIX + "vehicle_crash";
