...
public class VehiclePropertiesGen extends VehiclePropertiesProvider
{
    ...
    protected void registerProperties()
    {
        ...
        // Farfania
        this.add(ModEntities.DEPORTIVE.get(), VehicleProperties.builder()
                .setAxleOffset(-1.7F)
                .setBodyPosition(PartPosition.create(1.25))
                ...
                .setFrontAxleOffset(12)
                .setRearAxleOffset(-12)
                .addSeat(Seat.of(-4.5, 0.5, 2.0, true))
                .addSeat(Seat.of(-4.5, 0.5, -8.0, false))
                .addSeat(Seat.of(5.5, 0.5, 2.0, false))
                .addSeat(Seat.of(5.5, 0.5, -8.0, false))
                .setEngineType(EngineType.ELECTRIC_MOTOR)
                .setCanChangeWheels(true)
                .setColored(true));

        this.add(ModEntities.DEPORTIVE_2.get(), VehicleProperties.builder()
                .setAxleOffset(-1.7F)
                .setBodyPosition(PartPosition.create(1.25))
                .setFuelPortPosition(PartPosition.create(-13.0, 8.7, -15.3, 0.0, -90, 0.0, 0.25))
                .setDisplayPosition(PartPosition.create(1.35F))
        ...
        this.add(ModEntities.DEPORTIVE_3.get(), VehicleProperties.builder()
                .setAxleOffset(-1.7F)
                .setBodyPosition(PartPosition.create(1.25))
                .setFuelPortPosition(PartPosition.create(-13.0, 8.7, -15.3, 0.0, -90, 0.0, 0.25))
                .setDisplayPosition(PartPosition.create(1.35F))
